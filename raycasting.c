...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/01/11 14:27:04 by efichot           #+#    #+#             */
/*   Updated: 2017/01/18 15:59:56 by efichot          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ray_init(t_env *e, int x)
{
	...
	e->ray.delta.x = sqrt(1 + (e->ray.dir.y * e->ray.dir.y) / (e->ray.dir.x *
		e->ray.dir.x));
	e->ray.delta.y = sqrt(1 + (e->ray.dir.x * e->ray.dir.x) / (e->ray.dir.y *
		e->ray.dir.y));
	e->ray.hit = 0;
	e->ray.dist = -1;
	e->ray.hit_side = -1;
